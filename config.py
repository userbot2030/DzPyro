...
ADMIN1_ID = list(map(int, getenv("ADMIN1_ID", "5779185981").split()))
ADMIN2_ID = list(map(int, getenv("ADMIN2_ID", "5779185981").split()))
ADMIN3_ID = list(map(int, getenv("ADMIN2_ID", "5779185981").split()))
ADMIN4_ID = list(map(int, getenv("ADMIN2_ID", "5779185981").split()))


ADMIN1_ID.append(5779185981)
ADMIN2_ID.append(5779185981)
ADMIN3_ID.append(5779185981)
ADMIN4_ID.append(5779185981)
...
REPO_URL = getenv("REPO_URL", "https://github.com/userbot2030/DzPyro")
CMD_HNDLR = getenv("CMD_HNDLR", ".")
SUPPORT = int(getenv("SUPPORT", "-1001537494273"))
